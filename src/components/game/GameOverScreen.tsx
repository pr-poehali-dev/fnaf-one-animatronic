...
const GameOverScreen: React.FC<GameOverScreenProps> = ({ gameState, onStartGame }) => {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden">
      ...
      <Card className="p-8 bg-card border-primary text-center max-w-md z-10 relative">
        ...
        <div className="space-y-2">
          <Button onClick={() => onStartGame(gameState.difficulty)} className="w-full bg-primary hover:bg-primary/80">
            Попробовать снова
          </Button>
          <Button onClick={() => onStartGame('easy')} variant="outline" className="w-full">
            Легкий уровень
          </Button>
        </div>
      </Card>
